package sec1;
//Enum : 나열형 열거로 상속이나 인스턴스를 생성할 수 없음 => public, static, final
//데이터 값의 의미를 명확하게 해야 하거나 컴파일시에 데이터 타입 및 유효성 체크를 하려고 할 경우 활용한다.
...
enum Week2{
	SUN("일"), MON("월"), TUE("화"), WEN("수"), THU("목"), FRI("금"), SAT("토");
...
public class EnumExam1{
	public static void main(String[]args) {
		...
		for(Week2 w : arrWeek2) {
			//if(w ==Week2.MON) {
				System.out.println();
				System.out.println(w.ordinal()+"번째요일=>"+w.getDay());
			//}
		}
