...
public class StructuralPattern {
	...
	public static void main(String[] args) {
		System.out.println("Structural Pattern은 클래스를 확장하거나 합치므로써 클래스의 구조를 변경하는 패턴");
		System.out.println("종류에는 Adapter, Bridge, Composite, Decorator, Façade, Proxy, Flyweight 등 7개의 패턴");
		/*
