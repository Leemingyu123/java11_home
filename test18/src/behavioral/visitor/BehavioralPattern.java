...
public class BehavioralPattern {
	public static void main(String[] args) {
		System.out.println("Behavioral Pattern은 기능 즉, 메소드와 관련한 패턴");
		System.out.println("종류에는 Interpreter, Template, Command, Iterator, Mediator, Memento, Observer, Strategy, Visitor, Chain of Responsibility, State 등 11개의 패턴");
		/*
