...
public class test5 {
	...
	public static void main(String[] args) {
		...
		list.add(new Fruit("바나나", "노랑")); //list.add("바나나");	//list(ArrayList)의 제네릭 타입은 Fruit로 설정되어 있으므로
		//Fruit으로 객체를 생성하여 요소를 추가해야 하지만, 코드에서 String을 요소로 추가하였다. => Type MisMatch Error 발생 
