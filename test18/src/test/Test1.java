...
public class Test1 {
	...
	public static void main(String[] args) {
		...
		List<IPInfo> ipInfoList = new ArrayList<IPInfo>(); //ipInfoList는 ArrayList로 생성해야하지만, null로 대입하였으므로 ipInfoList에 요소를 추가(add) 14~16문장은 NullPointerException이 발생 List 인터페이스라 생성을 못한다.
