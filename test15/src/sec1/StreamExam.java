...
//파일/모니터/데이터 출력 : FileOutputStream, BufferedOutputStream, FildWriter, BufferedWriter
//Stream으로 끝나는 클래스는 데이터 입출력을 바이트 단위로 : FileInputStream, BufferedInputStream, FileOutputStream, BufferedOutputStream
//Stream으로 끝나지 않는 클래스는 데이터 입출력을 문자 단위로 : FileReader, BufferedReader, FildWriter, BufferedWriter
public class StreamExam {

	public static void main(String[] args) {
		String fileInputStream = "FileInputStream은 바이트 단위로 입력하기 위한 스트림";
		String bufferedInputStream = "BufferedInputStream은 바이트 단위로 입력하기 위한 스트림 : 메모리 버퍼로 로딩";
		String fileReader ="FileReader는 문자 단위로 입력하기 위한 스트림";
		String bufferedReader = "BufferedReader는 문자 단위로 입력하기 위한 스트림 : 메모리 버퍼로 로딩 후";
		String fileOutputStream = "FileOutputStream는 바이트 단위로 출력하기 위 한 스트림";
